...
(define-public heimdall-dsa
  (let ((commit "05bd3c6c81f549dbaf2ddfad82e058eca7bdb2b2")
        (revision "116"))
    (package
     (name "heimdall-astro")
     ...
     (source (origin
              ...
              (uri (git-reference
                    ...
                    (recursive? #t)))
              (sha256
               (base32 "1qb1j40r3y9hdddz3jbx7mg1rxcy850pqklvg0j9dsxqcmcldmfq"))))
...
(define-public snapctl
  (let ((commit "48aa9f341278f3d6eece35374279e645c8e3e7f3")
        (revision "40"))
    (package
     (name "snapctl")
     ...
     (source (origin
              ...
              (sha256
               (base32
                "1l9zvzr5k3qzdrw7fn202f4sjggkpmv6zbgdb17f48xf2j79xjvm"))))
